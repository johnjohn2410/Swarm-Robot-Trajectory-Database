...
├── README.md                # This file
├── robot.csv                # Robot ID and name data
├── robot.db                 # SQLite database file (generated by setup_database.py)
├── setup_database.py        # Python script to create DB and import data
├── query_tasks.py           # Python script to run SQL queries and analysis
├── t1.csv                   # Trajectory data for Robot 1
├── t2.csv                   # Trajectory data for Robot 2
├── t3.csv                   # Trajectory data for Robot 3
├── t4.csv                   # Trajectory data for Robot 4
├── t5.csv                   # Trajectory data for Robot 5
└── target_interval.csv      # Target time interval data
